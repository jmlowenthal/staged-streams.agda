...
open import C.Semantics.SmallStep.Properties
...
module Streams.Properties ⦃ _ : Lang ⦄ ⦃ _ : Semantics ⦄ where
...
≅-equiv {α} = record {
  ...
  trans = λ A B f → IsEquivalence.trans ≅ₚ-equiv (A f) (B f) ;
  sym = λ A f → IsEquivalence.sym ≅ₚ-equiv (A f) }
